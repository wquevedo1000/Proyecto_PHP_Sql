...
<center><h2 class="py-3" style="color: WHITE;"><i>Actualizar Administrador</i></h2></center>
<?php
    require_once "Conectar/connect.php";
    require_once "Procesos/actualizaradministrador.php";
?>
<center><a href="ListadoAdministrador.php" class="btn btn-light"><i>Volver</i></a></center>
<footer class="col-md-12 bg-light" style="margin-top: 148px;">
    <br>
