...
<center><h2 class="py-3" style="color: WHITE;"><i>Actualizar Perfil</i></h2></center>
<?php
    require_once "Conectar/connect.php";
    require_once "Procesos/actualizarcliente.php";
?>
<center><a href="Perfil.php" class="btn btn-light"><i>Volver</i></a></center>
<br>
<footer class="col-md-12 bg-light" style="margin-top: 10px;">
	<br>
