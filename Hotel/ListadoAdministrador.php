...
<body class="bg-dark">
    ...
    <center><h2 class="py-3" style="color: WHITE;"><i>Lista de Administradores</i></h2></center>
    <a href="RegistroAdministrador.php" class="btn btn-light"><i>Registrar Nuevo Administrador</i></a><br><br>
    <?php
        require_once "Conectar/connect.php";
        if(isset($_GET['id'])){
            require_once "Procesos/eliminaradministrador.php";
        }
    ?>
    <div class="table-responsive">
    <center><table class="table table-bordered table-sm" id="example">
        ...
        <tbody>
            <?php
                require_once "Procesos/seleccionaradministrador.php";
            ?>
        </tbody>
    </table></center>
    </div>
...
<br>
<br>
<footer class="col-md-12 bg-light" style="margin-top: 320px;">
    <br>
