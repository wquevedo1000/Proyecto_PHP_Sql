	...
	<nav class="navbar navbar-expand-lg bg-light navbar-light">
		...
		<div id="menu" class="collapse navbar-collapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a href="ListadoCliente.php" class="nav-link active"><i>Listado de Clientes</i></a>
				</li>
				<li class="nav-item">
...
<center><h2 class="py-3" style="color: WHITE;"><i>Listado de Clientes</i></h2></center>
<?php
    require_once "Conectar/connect.php";
    if(isset($_GET['id'])){
    	require_once "Procesos/eliminarcliente.php";
    }
?>
...
<table class="table table-bordered table-sm" id="example">
	<thead class="thead-light">
		<tr>
			...
			<th><i>Nombre</i></th>
			<th><i>Apellido</i></th>
			<th><i>Tipo de Identificación</i></th>
			<th><i>Número de Identificación</i></th>
			<th><i>Nacionalidad</i></th>
			<th><i>Ciudad</i></th>
			<th><i>Dirección</i></th>
			<th><i>Teléfono</i></th>
			<th><i>Email</i></th>
	...
	<tbody>
		<?php
		    require_once "Procesos/seleccionarcliente.php";
		?>
	</tbody>
</table>
</div>
