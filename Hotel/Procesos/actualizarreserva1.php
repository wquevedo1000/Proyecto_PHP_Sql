<?php
    if(isset($_POST['idreserva']) && isset($_POST['idcliente']) && isset($_POST['habitacion']) && isset($_POST['fecha']) && isset($_POST['fechaingreso']) && isset($_POST['horaingreso']) && isset($_POST['fechasalida']) && isset($_POST['horasalida'])){
