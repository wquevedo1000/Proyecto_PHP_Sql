...
<center><h2 class="py-3" style="color: WHITE;"><i>Listado de Reservas</i></h2></center><br>
<?php
    require_once "Conectar/connect.php";
?>
<h3 style="color: WHITE;"><i>Reservas Activas:</i></h3>
<div class="table-responsive">
<table class="table table-bordered table-sm" id="example">
	<thead class="thead-light">
		<tr>
			<th><i>Id de la reserva</i></th>
			<th><i>Nombre del cliente</i></th>
			<th><i>Apellido del cliente</i></th>
	...
	<tbody>
		<?php
		    require_once "Procesos/seleccionarreserva1.php";
		?>
	</tbody>
</table>
</div>
...
<table class="table table-bordered table-sm" id="example2">
	...
	<tbody>
		<?php
		    require_once "Procesos/seleccionarreserva2.php";
		?>
	</tbody>
</table>
</div>
