...
<center><h2 class="py-3" style="color: WHITE;"><i>Actualizar Habitación</i></h2></center>
<?php
    require_once "Conectar/connect.php";
    require_once "Procesos/actualizarhabitacion.php";
?>
...
<br>
<br>
<footer class="col-md-12 bg-light" style="margin-top: 268px;">
	<br>
